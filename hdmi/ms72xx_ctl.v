...
ms7200_ctl U1_ms7200_ctl(
 ...
 assign device_id = 8'h56 ;//device_id_tx : device_id_rx;
 assign iic_trig = iic_trig_rx;
 assign w_r = w_r_rx;
 assign addr = addr_rx;
 assign data_in = data_in_rx;
 
 assign busy_rx = (init_over_rx == 1'b0) ? busy : 0;
 assign data_out_rx = (init_over_rx == 1'b0) ? data_out : 0;
 assign byte_over_rx = (init_over_rx == 1'b0) ? byte_over : 0;
