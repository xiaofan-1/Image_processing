...
assign device_id = device_id_tx;//(init_over_rx == 1'b1 && init_over == 1'b0) ? 8'h56: 8'hb2 ;//device_id_tx : device_id_rx;
assign iic_trig = iic_trig_tx;//(init_over_rx == 1'b1 && init_over == 1'b0) ? iic_trig_tx : iic_trig_rx;
assign w_r = w_r_tx;//(init_over_rx == 1'b1 && init_over == 1'b0) ? w_r_tx : w_r_rx;
assign addr = addr_tx;//(init_over_rx == 1'b1 && init_over == 1'b0) ? addr_tx : addr_rx;
assign data_in = data_in_tx;//(init_over_rx == 1'b1 && init_over == 1'b0) ? data_in_tx : data_in_rx;

assign busy_tx = busy;//(init_over_rx == 1'b1 && init_over == 1'b0) ? busy : 0;
assign data_out_tx = data_out;//(init_over_rx == 1'b1 && init_over == 1'b0) ? data_out : 0;
assign byte_over_tx = byte_over;//(init_over_rx == 1'b1 && init_over == 1'b0) ? byte_over : 0;
