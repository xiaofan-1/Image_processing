...
begin
	if(!rst_n)
		post_img_Bit_r <= 1'b0;	 
			...
			if(per_img_Y_delay   > user_Threshold)	//灰度差大于阈值
...
//			post_img_Byte_r <= (per_img_Y_delay - YCbCr_img_Y_previous);  //灰度差大于阈值  
//		else 
//            post_img_Byte_r <= (YCbCr_img_Y_previous - per_img_Y_delay) ;	//灰度差大于阈值  
//	end
//end
