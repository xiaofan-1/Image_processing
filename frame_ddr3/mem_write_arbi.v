module mem_write_arbi #(
    ...
    input   wire                            ch0_wr_burst_req        ,
    input   wire    [BURST_BITS - 1:0]      ch0_wr_burst_len        ,
    input   wire    [ADDR_BITS - 1:0]       ch0_wr_burst_addr       ,
    output  wire                            ch0_wr_burst_data_req   ,
    input   wire    [MEM_DATA_BITS - 1:0]   ch0_wr_burst_data       ,
    output  wire                            ch0_wr_burst_finish     ,
    
    input   wire                            ch1_wr_burst_req        ,
    input   wire    [BURST_BITS - 1:0]      ch1_wr_burst_len        ,
    input   wire    [ADDR_BITS - 1:0]       ch1_wr_burst_addr       ,
    output  wire                            ch1_wr_burst_data_req   ,
    input   wire    [MEM_DATA_BITS - 1:0]   ch1_wr_burst_data       ,
    output  wire                            ch1_wr_burst_finish     ,
    
    input   wire                            ch2_wr_burst_req        ,
    input   wire    [BURST_BITS - 1:0]      ch2_wr_burst_len        ,
    input   wire    [ADDR_BITS - 1:0]       ch2_wr_burst_addr       ,
    output  wire                            ch2_wr_burst_data_req   ,
    input   wire    [MEM_DATA_BITS - 1:0]   ch2_wr_burst_data       ,
    output  wire                            ch2_wr_burst_finish     ,
    
    input   wire                            ch3_wr_burst_req        ,
    input   wire    [BURST_BITS - 1:0]      ch3_wr_burst_len        ,
    input   wire    [ADDR_BITS - 1:0]       ch3_wr_burst_addr       ,
    output  wire                            ch3_wr_burst_data_req   ,
    input   wire    [MEM_DATA_BITS - 1:0]   ch3_wr_burst_data       ,
    output  wire                            ch3_wr_burst_finish     ,

    input   wire                            ch4_wr_burst_req        ,
    input   wire    [BURST_BITS - 1:0]      ch4_wr_burst_len        ,
    input   wire    [ADDR_BITS - 1:0]       ch4_wr_burst_addr       ,
    output  wire                            ch4_wr_burst_data_req   ,
    input   wire    [MEM_DATA_BITS - 1:0]   ch4_wr_burst_data       ,
    output  wire                            ch4_wr_burst_finish     ,

    input   wire                            ch5_wr_burst_req        ,
    input   wire    [BURST_BITS - 1:0]      ch5_wr_burst_len        ,
    input   wire    [ADDR_BITS - 1:0]       ch5_wr_burst_addr       ,
    output  wire                            ch5_wr_burst_data_req   ,
    input   wire    [MEM_DATA_BITS - 1:0]   ch5_wr_burst_data       ,
    output  wire                            ch5_wr_burst_finish     ,
    
    output  reg                             wr_burst_req            ,
    output  reg     [BURST_BITS - 1:0]      wr_burst_len            ,
...
begin
    case(write_state)
        ...
        //
        CH0_CHECK:
            if(ch0_wr_burst_req  && ch0_wr_burst_len != {BURST_BITS{1'd0}})
        ...
        //	
        CH1_CHECK:
            if(ch1_wr_burst_req && ch1_wr_burst_len != {BURST_BITS{1'd0}})
        ...
        //	
        CH2_CHECK:
            if(ch2_wr_burst_req && ch2_wr_burst_len != {BURST_BITS{1'd0}})
        ...
        //	
        CH3_CHECK:
            if(ch3_wr_burst_req && ch3_wr_burst_len != {BURST_BITS{1'd0}})
        ...
        //	
        CH4_CHECK:
            if(ch4_wr_burst_req && ch4_wr_burst_len != {BURST_BITS{1'd0}})
        ...
        //	
        CH5_CHECK:
            if(ch5_wr_burst_req && ch5_wr_burst_len != {BURST_BITS{1'd0}})
...
begin
    if(~rst_n)
        wr_burst_req <= 1'b0;
    else if(write_state == CH0_BEGIN || write_state == CH1_BEGIN || write_state == CH2_BEGIN || write_state == CH3_BEGIN || write_state == CH4_BEGIN || write_state == CH5_BEGIN)
        wr_burst_req <= 1'b1;
